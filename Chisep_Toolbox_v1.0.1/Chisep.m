...
if(~exist([HomeDirectory filesep 'initialize' filesep 'ToolboxDirectory.mat'],'file'))
    f=SetToolBoxDirectoryApp(HomeDirectory);
    uiwait(f.UIFigure);
end
load([HomeDirectory filesep 'initialize' filesep 'ToolboxDirectory.mat'],'MEDIDirectory','STISuiteDirectory','SEGUEDirectory','MRItoolsDirectory');
addpath(genpath(MEDIDirectory));
addpath(genpath(STISuiteDirectory));
addpath(genpath(SEGUEDirectory));
addpath(genpath(MRItoolsDirectory));
    
ChisepToolbox(HomeDirectory);
end